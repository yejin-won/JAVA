...
<h3>고객명단 리스트</h3>
	...
	%>
		<tr>
			<td><a href="purchaserSelect_02.jsp?name=<%=rs.getString(2) %>&tel=<%=rs.getString(3) %>&address=<%=rs.getString(4) %>&insertdate=<%=rs.getString(5) %>&userid=<%=rs.getString(1) %>"><%=rs.getString(1) %></td>
