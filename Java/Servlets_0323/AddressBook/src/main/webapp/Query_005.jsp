...
function update(Seq){
	location.href = "http://192.168.150.167:8080/AddressBook/Query_03.jsp?Seq="+Seq;
}
function del(Seq){
...
String url_mysql = "jdbc:mysql://http://192.168.150.135:8080/AddressBook?serverTimezone=Asia/Seoul&characterEncoding=utf8&useSSL=false";
